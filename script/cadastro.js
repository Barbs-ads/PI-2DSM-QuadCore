...
document.addEventListener("DOMContentLoaded", function () {
  document
    .getElementById("cep-instituicao")
    .addEventListener("blur", function () {
      ...
      if (cep.length === 8) {
        fetch(`https://viacep.com.br/ws/${cep}/json/`)
          ...
          .then((dados) => {
            if (!dados.erro) {
              document.getElementById("logradouro-instituicao").value =
                dados.logradouro;
              document.getElementById("bairro-instituicao").value =
                dados.bairro;
